...
namespace Chip8Library
{
    ...
    class Chip8
    {
        ...
        public delegate void OutputRegistersHandler(byte[] V, ushort I, ushort PC);
        ...
        public void Cycle()
        {
            ...
            OutputRegisters(V, Index, ProgrammCounter);
        }
                ...
                case (byte)0x0u:
                    ...
                    switch (command.Get000X)
                    {
                        ...
                        case (byte)0xEu:
                            ...
                            break;
                        default:
                            throw new Exception($"Unknown command {command.GetCommandCode.ToString("X4")}");
                            break;
                    }
